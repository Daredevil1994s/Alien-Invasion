...
class AlienInvasion():
    ...
    def _check_events(self):
            ...
            # Обрабатывает нажатие клавиатуры и мыши.
    ...
    def _update_aliens(self):
        '''Обновляет позиции всех пришельцов во флоте'''
    ...
    def _create_fleet(self):
        ...
        number_rows = availabel_space_y // (3 * alien_height)
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # происходит то же, что при столкновении
                self._ship_hit()
                break
